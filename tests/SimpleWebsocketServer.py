...
Almost a carbon copy of https://github.com/dpallot/simple-websocket-server/blob/master/SimpleWebSocketServer/SimpleWebSocketServer.py
I just modified it slightly to be able to use it in thread (and thus py.test)
'''
import base64
import codecs
import errno
